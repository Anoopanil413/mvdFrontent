...
const SearchVehicle = () => {
  ...
  return (
    <>
        ...
        <div className="bg-gray-50 flex flex-col items-center justify-center h-auto">
          <div className="w-full flex flex-col items-center justify-center space-y-8">
            <div className="max-w-sm mx-auto">
              <img src={searchVEhicle} alt="City skyline" className="" />
            </div>
      ...
      {vehicleOwnerAvailable &&
        (vehicleOwnerAvailable && state.vehicleOwnerLIst.length > 0 ? (
          <>
            <VehicleSearchResults
              results={state.vehicleOwnerLIst}
              handleUseraAvailableToggel={handleUseraAvailableToggel}
            />
          </>
        ) : (
          <>
            <NoVehicleResults
              searchedNumber={vehicleNumber}
              handleUseraAvailableToggel={handleUseraAvailableToggel}
            />
          </>
        ))}
