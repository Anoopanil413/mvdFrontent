      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-4">
          <div className="inline-flex items-center justify-center space-x-2 bg-orange-50 px-4 py-2 rounded-full">
            ...
            <span className="text-orange-600 font-medium">No Vehicle Found</span>
          </div>
          ...
          {searchedNumber && (
            <p className="text-gray-600">
              ...
              <span className="font-medium text-blue-600">{searchedNumber.toUpperCase()}</span>
            </p>
          )}
          
          <p className="text-gray-500 max-w-sm mx-auto">
            The vehicle you're looking for might not be registered in our system.
        ...
        <p className="text-sm text-gray-500">
          ...
          <button className="text-blue-500 hover:underline">support team</button>
        </p>
      </div>
    </div>
  );
